...
// Industry outlook (DEMO synth — CapIQ/IBIS placeholder). NAICS 332710 machine shops, aero/defense lean.
const peers = { _source: "CAPIQ-IBIS-PLACEHOLDER", industryOutlook: {
  naics: a.naics,
